...
Page({
  ...
  onLoad(params) {
    ...
    this.setData({
      ...
      task_name: item.task_name || name,
      keyword: item.keyword || '',
      watch_min: item.watch_min || '8',
      watch_max: item.watch_max || '18',
      count_min: item.count_min || '20',
      count_max: item.count_max || '80',
      like_rate: item.like_rate != null ? item.like_rate : 20,
      auto_comment: item.auto_comment !== false,
